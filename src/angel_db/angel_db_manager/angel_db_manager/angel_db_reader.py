...
from angel_msg_db.msg import Angeldb
from angel_msg_db.srv import AngeldbGetData
import rclpy
import pymongo
import angel_db_manager.angel_db_util as db_util
...
class TmsDbReader(Node):
    ...
    def __init__(self):
        super().__init__('angel_db_reader')
        self.srv = self.create_service(AngeldbGetData, 'tms_db_reader', self.dbReaderSrvCallback)

    def dbReaderSrvCallback(self, request, response):
        response_tmsdb = Angeldb()
